...
import Item, { generateMetadata } from "@/app/items/[idItem]/page";
...
const params = { idItem: "test" };

describe("Item Component", () => {
  test("renders Item component", async () => {
    const jsx = await Item({ params });
    render(jsx);
  });

  test("generate metadata Item component", async () => {
    const data = await generateMetadata({ params });
    expect(data.title).toEqual("Apple iPhone 11 (128 Gb) - Blanco");
  });
});
